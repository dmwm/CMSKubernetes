...
helm upgrade --values cms-rucio-common.yaml,cms-rucio-server.yaml,cms-rucio-server-dev.yaml,cms-rucio-dev-db.yaml cms-rucio-testbed rucio/rucio-server
...
helm upgrade --values cms-rucio-common.yaml,cms-rucio-analysis-daemons.yaml,cms-rucio-daemons-dev.yaml,cms-rucio-dev-db.yaml cms-analysisd-testbed rucio/rucio-daemons
