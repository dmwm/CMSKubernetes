...
urls="$url/couchdb $url/acdcserver/_all_docs $url/reqmgr2/data/info $url/dbs/$inst/global/DBSReader/datasets?dataset=/ZMM*/*/* $url/das $url/workqueue/index.html $url/phedex $url/phedex/datasvc/doc $url/t0_reqmon/data/info $url/crabserver/preprod/info $url/crabcache/info $url/wmstatsserver/data/info $url/wmstats/index.html $url/t0wmadatasvc/replayone/hello $url/exitcodes $url/wmarchive/data $url/ms-transferor/data/status $url/ms-monitor/data/status $url/ms-output/data/status $url/ms-rulecleaner/data/status $url/ms-unmerged/data/status?rses=t1 $url/ms-unmerged/data/status?rses=t2-t3 $url/ms-unmerged/data/status?rses=t2-t3-us"
