...
BASE_PATH="/project/awg/cms/dbs3verify/CMS_DBS3_PROD_GLOBAL/datasets"
...
sqoop import --direct --connect $JDBC_URL --fetch-size 10000 --username $USERNAME --password $PASSWORD --target-dir $OUTPUT_FOLDER -m 1 --query \
