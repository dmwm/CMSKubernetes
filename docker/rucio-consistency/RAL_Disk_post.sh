...
./RAL_compare.sh /config/config.yaml /opt/rucio/etc/rucio.cfg T1_UK_RAL_Disk /var/cache/consistency-temp/ /var/cache/consistency-dump/ -u /unmerged-config/config.yaml /var/cache/consistency-dump/unmerged/
