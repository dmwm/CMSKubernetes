...
cmssw_pkgs="proxy frontend exporters exitcodes nats-sub das dbs2go dbs reqmgr2 reqmgr2ms reqmon workqueue confdb crabserver crabcache cmsmon dmwmmon t0_reqmon t0wmadatasvc dbsmigration httpgo httpsgo"
