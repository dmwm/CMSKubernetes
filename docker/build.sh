...
cmssw_pkgs="proxy frontend exporters exitcodes nats-sub das das-server das-mongo dbs2go dbs reqmgr2 reqmgr2ms reqmon workqueue crabserver crabcache cmsmon dmwmmon t0_reqmon t0wmadatasvc dbsmigration httpgo httpsgo"
