...
cmssw_pkgs="proxy frontend exporters exitcodes das das-server das-mongo dbs reqmgr2 reqmgr2ms reqmon workqueue crabserver crabcache t0_reqmon t0wmadatasvc dbsmigration wmarchive"
