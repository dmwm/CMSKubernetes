...
cmssw_pkgs="cmsweb frontend exporters das2go dbs2go dbs couchdb reqmgr reqmon workqueue"
repo=cmssw
...
priv_pkgs="dbsmigration crabserver crabcache dqmgui t0_reqmon t0wmadatasvc httpgo httpsgo tfaas"
repo=veknet
